...
axis[0, 1].plot(x, P, color = 'r', linestyle = 'solid', marker = '',label = "Pressure")
axis[0, 1].plot(x, Kp, color = 'g', linestyle = 'solid', marker = '',label = "Kalman pressure")
...
axis[1, 0].plot(x, AltP, color = 'r', linestyle = 'solid', marker = '',label = "Altitude pressure")
axis[1, 0].plot(x, Alt, color = 'g', linestyle = 'solid', marker = '',label = "Altitude")
...
axis[1, 1].plot(x, Vaxis, color = 'r', linestyle = 'solid', marker = '',label = "Velocity")
axis[1, 1].plot(x, Vp, color = 'g', linestyle = 'solid', marker = '',label = "Velocity pressure")
